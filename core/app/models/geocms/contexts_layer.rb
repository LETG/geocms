module Geocms
  class ContextsLayer < ActiveRecord::Base
    ...
    delegate :title, :description, :name, :tiled, :template, :thumbnail_url, :default_style,
             :data_source_wms, :data_source_wms_version, :data_source_not_internal, :download_url, :type_import,
             :data_source_ogc, :data_source_name, :bbox, :metadata_url, :max_zoom, :single_tiled, to: :layer
