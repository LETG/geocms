module Geocms
  class ContextPreviewWorker
    ...
    def perform(context_id, current_tenant_id)
      ...
      remote_preview_url = "#{current_tenant.screenshot_url.value}?url=#{current_tenant.host.value}#{current_tenant.prefix_uri.value}#{context.share_url}?screenshotMode&delay=15000"
